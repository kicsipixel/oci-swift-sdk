...
public enum Region: String, CaseIterable, Sendable {
  case ams, arn, auh, beg, bog, bom, cdg, cwl, dxb, fra, gru, hsg, hyd, iad,
    icn, jbp, jed, jnb, kix, lej, lhr, lin, mad, mel, mrs, mty, mtz, nrq, nrt,
    ord, orf, phx, qro, ruh, scl, sin, sjc, syd, vap, vcp, xsp, yny, yul, yyz,
    zrh
...
public enum Service: String {
  case language, objectstorage, generativeai, iam, secrets, containerinstances, monitoringingestion
